const {userSchema, loginSchema, productSchema, orderSchema, editConsumerDataSchema} = require("./schemas")
...
module.exports = {
    ...
    editConsumerDataRequestValidation: createRequestBodyValidation(editConsumerDataSchema)
}